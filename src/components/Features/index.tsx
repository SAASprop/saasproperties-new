    ...
    >
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div
          ...
          style={
            { "--fade-scrim": 0.55, "--fade-edge": 0.93 } as React.CSSProperties
          }
        />
        <div
      ...
      <div className="mx-auto max-w-[1600px] px-5 md:px-[3.75rem]">
        ...
        <ul className="mt-14 grid list-none grid-cols-2 gap-3 p-0 sm:gap-4 md:grid-cols-3 lg:mt-12 lg:grid-cols-4 lg:gap-4">
          {features.items.map((item) => (
            ...
            >
              <div className="flex h-full flex-col items-center justify-center gap-1 px-4 text-center sm:gap-4 sm:px-5">
                <FeatureGlyph
                  icon={item.icon}
